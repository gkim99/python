...
class User:
    ...
    def validate_register(user):
        ...
        if len(user['first_name']) == 0:
            ...
            flash("First name must only contain alphabetic characters", "register")
            is_valid = False
        ...
        if len(user['last_name']) == 0:
            ...
            flash("Last name must only contain alphabetic characters", "register")
            is_valid = False

        if len(user['email']) == 0:
            flash("Email is a required field", "register")
            is_valid = False
        ...
        if len(user['password']) == 0:
            flash("Password is a required field", "register")
            is_valid = False
